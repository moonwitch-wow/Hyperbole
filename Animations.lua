...
-- local fadeGroup = ObjectiveTrackerFrame:CreateAnimationGroup()
-- local fadeAnim = fadeGroup:CreateAnimation("Alpha")
-- fadeGroup:SetLooping("NONE")
-- fadeGroup:SetScript("OnFinished", function(self) ObjectiveTrackerFrame:SetAlpha(self.targetAlpha) end)
-- ObjectiveTrackerFrame:SetAlpha(FADE_OUT_ALPHA)
...
--                 if parent == ObjectiveTrackerFrame then
--                         t[f] = true
--                         return true
--                 end
...
-- ObjectiveTrackerFrame:HookScript("OnUpdate", function(self, elapsed)
